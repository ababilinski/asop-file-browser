...
public actor MTPSession {
    ...
    /// Fetch the device-generated thumbnail for an object without downloading the full file.
    public func thumbnail(_ handle: UInt32) throws -> Data {
        try Task.checkCancellation()
        return try receiveData(.getThumb, params: [handle])
    }
